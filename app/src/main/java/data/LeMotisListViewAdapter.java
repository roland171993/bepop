 ...
 */
public class LeMotisListViewAdapter extends ArrayAdapter<LettreMotivation>{

    private int layoutResource;
    private Activity activity;
    private ArrayList<LettreMotivation> leMotisList = new ArrayList<>();

    public LeMotisListViewAdapter(Activity act, int resource, ArrayList<LettreMotivation> data ) {
    ...
    public void addListItemToAdapter(ArrayList<LettreMotivation> list) {
        //Add list to current array list of data
        leMotisList.addAll(list);
        //Notify UI
